...
double RayTraceSphereMouse(double mouseX, double mouseY, DirectX::SimpleMath::Vector4 sphericalPosition, DirectX::SimpleMath::Matrix view, DirectX::SimpleMath::Matrix proj);
