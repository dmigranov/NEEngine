...
int main(int argc, char* argv[])
{
    ...
    auto effect = new SphericalExpFogEffect(earthTexture, 2, DirectX::Colors::PowderBlue);

    auto charWalkComponent = new WalkComponent(3, 4);
    auto charInputComponent = new InputComponent();

    auto smc = SphericalMeshComponentFactory::CreateSphericalSphere(0.3, 30, 30); //200 triangles
