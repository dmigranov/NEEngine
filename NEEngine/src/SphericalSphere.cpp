...
SphericalSphere::SphericalSphere(float radius, int sliceCount, int stackCount, Texture* texture)
    : SphericalSphere(radius, sliceCount, stackCount, texture, Matrix::Identity)
{
}
