...
SphericalRenderSystem::SphericalRenderSystem()
{
	...
	//короче, дл€ начала SphericalMeshComponent и SphericalTransformComponent
	//EllipticalRenderSystem работает с ними же!
	//теперь вместо SphericalMeshComponent - общий дл€ вообще всех!
	//это просто вершины, на корректность можно провер€ть в другом месте (напр., тут)
...
void SphericalRenderSystem::Render(Entity* pEntity, ID3D11DeviceContext* pDeviceContext, ID3D11Resource* pConstantBuffer)
{
	...
	// Ё“ќ ¬—® “ќ∆≈ перенести потом в Ё‘фект/ћатериал
