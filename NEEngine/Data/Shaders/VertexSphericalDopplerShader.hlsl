...
)
{
	...
	double distanceCenter; //рассто€ние от наблюдател€ до центра объекта, чтобы дл€ всех его точек было одинаково
	//€ не прибавл€ю к нему pi, так как при вычислении разницы это pi устранитс€, 
	...
	OUT.velocity = distDiff / deltaTime; //разна€ дл€ разных точек объекта!
